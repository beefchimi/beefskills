---
name: react-dev
description: React and TypeScript performance and best-practices guidelines for non-Next.js applications. Use when writing, reviewing, or refactoring React/TypeScript code—components, client-side data fetching, bundle optimization, or performance. Does not apply to Next.js; for Next.js use a framework-specific skill.
license: MIT
metadata:
  version: "1.0.0"
---
...
Performance and best-practices guide for React and TypeScript applications (no Next.js). Contains rules across 7 categories, prioritized by impact for refactoring and code generation.
...
- `bundle-barrel-imports` - Barrel files OK for your library; direct imports for large third-party packages
